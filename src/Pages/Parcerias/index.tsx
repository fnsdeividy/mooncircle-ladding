...
import  { InputNomeEstabelecimento, InputNomeInstagram } from '../../components/Input'

const Parcerias = () => {
  const [establishmentName, setEstablishmentName] = useState('');
  const [instagramUsername, setInstagramUsername] = useState('');

  function handleEstablishmentNameChange(event: ChangeEvent<HTMLInputElement>): void {
    const establishment = event.target.value;
    setEstablishmentName(establishment);
  }

  function handleInstagramUsernameChange(event: ChangeEvent<HTMLInputElement>): void {
